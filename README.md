...
1. **配置高德地图API密钥**
   - 在[高德开放平台](https://lbs.amap.com/)申请API密钥
...
- [需求文档](app/需求/) - 详细的功能需求说明
- [技术文档](md/) - 技术实现细节和问题解决记录
- [API文档](kotlin-client/docs/) - 后端API接口文档
...
- [高德地图](https://lbs.amap.com/) - 提供地图和定位服务
- [Whisper](https://github.com/openai/whisper) - 语音识别引擎
